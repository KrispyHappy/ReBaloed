	...
	SMODS.Challenge{
        ...
        restrictions = {
            banned_cards = { {id = 'j_joker'}, {id = 'j_jolly'}, {id = 'j_zany'}, {id = 'j_mad'}, {id = 'j_crazy'}, {id = 'j_droll'}, {id = 'j_half'}, {id = 'j_ceremonial'}, {id = 'j_mystic_summit'}, {id = 'j_abstract'}, {id = 'j_gros_michel'}, {id = 'j_ride_the_bus'}, {id = 'j_green_joker'}, {id = 'j_red_card'}, {id = 'j_erosion'}, {id = 'j_fortune_teller'}, {id = 'j_flash'}, {id = 'j_popcorn'}, {id = 'j_trousers'}, {id = 'j_swashbuckler'},
